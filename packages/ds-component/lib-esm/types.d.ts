 ...
 */
export declare type DSRow = DSRowValue[];
/**
 * A value for an entry in a DSRow.
 */
export declare type DSRowValue = string | number | boolean;
...
export declare type DataElementOptions = MetricOptions | DimensionOptions | SortOptions | MaxResultsOptions;
export declare enum ConfigStyleElementType {
    /**
...
export declare type ConfigDataId = string;
export declare type ConfigStyleId = string;
export declare type ConfigDataElementId = string;
export declare type ConfigStyleElementId = string;
...
export declare type ParsedRow = ParsedRowValue[];
...
export declare type ParsedRowValue = string | number | boolean | ParsedImage;
export declare type RowHeading = Field & {
    configId: string;
};
export declare type RowEntry = string | number | boolean;
export declare type Row = RowEntry[];
export interface FieldsByConfigId {
    [configId: string]: Field[];
}
export declare type StyleTheme = any;
export declare type StyleEntry = any;
export declare type StyleValue = StyleTheme | StyleEntry;
...
export declare type TableTransform = (message: Message) => TableFormat;
export declare type ConfigId = string;
...
export declare type ObjectTransform = (message: Message) => ObjectFormat;
export declare enum ToDSMessageType {
    VIZ_READY = "vizReady",
...
export interface SendInteraction {
    (actionId: InteractionId, interaction: InteractionType.FILTER, data: FilterInteractionData): void;
}
export interface ClearInteraction {
    (actionId: InteractionId, interaction: InteractionType.FILTER, data: undefined): void;
}
export declare type ConceptId = string;
export declare type FilterParamValue = string | number | boolean;
...
export declare type InteractionData = FilterInteractionData;
